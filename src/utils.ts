...
export class Utils {
  ...
  static readonly DEFAULT_COLOR_PALETTE_CHARTJS_TRANSPARENT: string[] = [
    'rgba(31, 119, 180, 0.5)', // steel blue
    'rgba(214, 39, 40, 0.5)', // red
    'rgba(44, 140, 140, 0.5)', // teal
    'rgba(227, 119, 0, 0.5)', // orange
    'rgba(148, 103, 189, 0.5)', // purple
    'rgba(188, 128, 0, 0.5)', // gold
    'rgba(140, 140, 140, 0.5)', // gray
    'rgba(0, 0, 200, 0.5)', // blue
    'rgba(0, 130, 0, 0.5)', // green
    'rgba(200, 0, 0, 0.5)', // bright red
    'rgba(230, 115, 0, 0.5)', // bright orange
    'rgba(180, 0, 180, 0.5)', // magenta
    'rgba(0, 150, 0, 0.5)', // bright green
    'rgba(150, 0, 150, 0.5)', // purple
    'rgba(0, 140, 140, 0.5)', // cyan
    'rgba(180, 140, 0, 0.5)', // olive gold
    'rgba(128, 0, 128, 0.5)', // purple
    'rgba(0, 100, 100, 0.5)', // dark cyan
    'rgba(100, 100, 0, 0.5)', // olive
